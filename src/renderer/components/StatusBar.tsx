...
const s = (t: Theme): Record<string, React.CSSProperties> => ({
  bar: { display:'flex',justifyContent:'space-between',alignItems:'center',padding:'8px ${SPACING.lg}px',background:t.panelBg,fontSize:11,color:t.textTertiary,flexShrink:0,borderTop:`1px solid ${t.border}`,boxShadow:'none' },
